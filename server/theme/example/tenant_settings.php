 ...
 * required for the Example Theme customisation page for a specific tenancy.
 */
...
$settings = new admin_externalpage(
    ...
    "$CFG->wwwroot/totara/tui/theme_settings.php?theme_name=example&tenant_id=$tenant->id",
